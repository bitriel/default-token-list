...
const indraTest = require("../tokens/indra-testnet.json");

module.exports = function buildList() {
  const parsed = version.split(".");
  return {
    name: "BitrielSwap Menu",
    ...
    tags: {},
    logoURI:
      "https://avatars.githubusercontent.com/u/39110528?s=200&v=4",
    keywords: ["bitrielswap", "default"],
    tokens: [
      ...mainnet,
      ...ropsten,
      ...goerli,
